...
/**
 * @param tagetPath 需要copy至的目标路径，path+文件名.jpg
 */
internal fun copyToCache(context: Context, imageFile: File,tagetPath: String): File {
    ///*${cachePath(context)}${imageFile.name}*/
    ///storage/emulated/0/Download---测试查看用的位置
    return imageFile.copyTo(File(tagetPath), true)
}
